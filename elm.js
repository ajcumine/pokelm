...
var rtfeldman$elm_css$Css$column = _Utils_update(
	...
	{value: 'column'});
var rtfeldman$elm_css$Css$contain = {lengthOrAutoOrCoverOrContain: rtfeldman$elm_css$Css$Structure$Compatible, value: 'contain'};
...
var rtfeldman$elm_css$Css$Transitions$background = rtfeldman$elm_css$Css$Transitions$durationTransition(rtfeldman$elm_css$Css$Transitions$Background);
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											rtfeldman$elm_css$Css$Transitions$background(500)
										])),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('Pokédex')
						])),
	...
	switch (model.$) {
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						author$project$Page$Pokemon$viewPokemonDetails(pokemon)
					]));
	}
};
	...
	switch (model.$) {
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						author$project$Page$PokemonType$viewType(pokemonType)
					]));
	}
};
	...
	switch (model.$) {
		...
		default:
			...
			return A2(
				...
				A2(elm$core$List$map, author$project$Page$Types$viewType, pokemonType));
	}
};
	...
	switch (_n0.$) {
		...
		case 'Pokedex':
			return A2(
				...
				_List_fromArray(
					[
						author$project$Page$Pokedex$view(model.pokedex)
					]));
		case 'Pokemon':
			var id = _n0.a;
			return A2(
				...
				_List_fromArray(
					[
						author$project$Page$Pokemon$view(model.pokemon)
					]));
		case 'Types':
			return A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						author$project$Page$Types$view(model.types)
					]));
		default:
			var id = _n0.a;
			return A2(
				...
				_List_fromArray(
					[
						author$project$Page$PokemonType$view(model.pokemonType)
					]));
	}
};
